# -*- coding: utf-8 -*-
"""
Created on Tue Mar 30 20:19:28 2021
...
#load model
model =load_model("C:\\Users\\HP\\Desktop\\iot project\\cotton_disease_folder\\model\\v4_pred_cott_dis.h5")
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('C:\\Users\\HP\\Desktop\\iot project\\cotton_disease_folder\\static', filename)
        file.save(file_path)
